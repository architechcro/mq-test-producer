package hr.architech.mqtestproducer.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer(javax.cache.configuration.Configuration<Object, Object> jcacheConfiguration) {
        return cm -> {
            createCache(cm, hr.architech.mqtestproducer.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            createCache(cm, hr.architech.mqtestproducer.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
