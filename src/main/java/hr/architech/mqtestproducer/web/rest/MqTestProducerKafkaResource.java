...
@RestController
@RequestMapping("/api/mq-test-producer-kafka")
public class MqTestProducerKafkaResource {
    private final Logger log = LoggerFactory.getLogger(MqTestProducerKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MqTestProducerKafkaResource(KafkaProperties kafkaProperties) {
